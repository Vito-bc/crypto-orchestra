...
public hydration. Exact source-file hashes, the declared numerical dependency
pins, and the installed environment form one content-addressed provenance
identity; input identity is a window-scoped logical OHLCV hash. The interpreter
